...
contract TestHelperCall is Test, HelperCall {
    ...
    /**
     * Tests for doFunctionCall(address target, bytes memory callData)
     */
    ...
    function test_doFunctionCall_require_fail_handling_with_actor() public {
        bytes memory callData = abi.encodeWithSignature("requireFailFunction()");
        (bool success, bytes memory returnData) = this.doFunctionCall(address(target), callData, actor1);
    ...
    function test_doFunctionCall_empty_calldata_with_actor() public {
        bytes memory callData = "";
        (bool success, bytes memory returnData) = this.doFunctionCall(address(target), callData, actor1);
    ...
    function test_doFunctionCall_invalid_function_signature_with_actor() public {
        bytes memory callData = abi.encodeWithSignature("nonExistentFunction()");
        (bool success, bytes memory returnData) = this.doFunctionCall(address(target), callData, actor1);
    ...
    function test_doFunctionCall_target_address_zero_with_actor() public {
        bytes memory callData = abi.encodeWithSignature("setValue(uint256)", 123);
        (bool success, bytes memory returnData) = this.doFunctionCall(address(0), callData, actor1);
    ...
    function test_doFunctionCall_target_non_contract_with_actor() public {
        address nonContract = address(0x9999);
        ...
        bytes memory callData = abi.encodeWithSignature("setValue(uint256)", 123);
        (bool success, bytes memory returnData) = this.doFunctionCall(nonContract, callData, actor1);
    ...
    function test_doFunctionCall_return_data_with_actor() public {
        bytes memory callData = abi.encodeWithSignature("returnMultiple()");
        (bool success, bytes memory returnData) = this.doFunctionCall(address(target), callData, actor1);
        ...
        assertEq(num, 42);
        assertEq(str, "test");
        // Note: returnMultiple() is a view function, so lastCaller is not updated
    }

    function test_doFunctionCall_large_return_data_with_actor() public {
        bytes memory callData = abi.encodeWithSignature("returnLargeData()");
        (bool success, bytes memory returnData) = this.doFunctionCall(address(target), callData, actor1);
        ...
        string memory result = abi.decode(returnData, (string));
        assertEq(bytes(result).length, 1000);
        // Note: returnLargeData() is a view function, so lastCaller is not updated
    }

    /**
     * Tests for doFunctionStaticCall(address target, bytes memory callData)
     */
